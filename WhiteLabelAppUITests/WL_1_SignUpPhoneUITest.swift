...
class WL_1_SignUpPhoneUITest: WhiteLabelAppUITests {
    ...
    let lName = "Smith"
    let uName = "Jacksmith"
    let email = "jack@smith.com"
    let phone = "9876543300"
    let address = ""
    let city = ""
    let state = ""
    let zip = ""
    ...
    func initial() {
        elementsQuery.buttons["Create Now!"].tap()
        wait(for: apiDelay)
    }
    
    func scrollUp() {
        let signupDefaultUserElement = scrollViewsQuery.otherElements.containing(.image, identifier:"signup_default_user").element
        signupDefaultUserElement.swipeUp()
    }
    
    func scrollDown() {
        let signupDefaultUserElement = scrollViewsQuery.otherElements.containing(.image, identifier:"signup_default_user").element
        signupDefaultUserElement.swipeDown()
    }
    
    func buttonCreateAction(screenShotName: String) {
        elementsQuery.buttons["Create"].tap()
    ...
    func otpValidiationWithResendOtp() {
        ...
        submitButton.tap()
        snapshot("1.2.2EnterOtp",timeWaitingForIdle: 3)
        ...
        snapshot("1.2.3ResendOtp",timeWaitingForIdle: 10)
    ...
    func OTPValidiation() {
        ...
        snapshot("1.2.4InvalidOtp",timeWaitingForIdle: 3)
        ...
        snapshot("1.2.5Success",timeWaitingForIdle: 15)
