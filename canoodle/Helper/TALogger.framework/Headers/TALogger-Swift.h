...
#ifndef TALOGGER_SWIFT_H
#define TALOGGER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="TALogger",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_PROTOCOL("_TtP8TALogger10AnchorView_")
@protocol AnchorView
...
SWIFT_CLASS("_TtC8TALogger8DropDown")
...
@interface DropDown (SWIFT_EXTENSION(TALogger))
...
@interface DropDown (SWIFT_EXTENSION(TALogger)) <UITableViewDataSource, UITableViewDelegate>
...
SWIFT_CLASS("_TtC8TALogger12DropDownCell")
...
@interface DropDownCell (SWIFT_EXTENSION(TALogger))
- (void)awakeFromNib;
...
SWIFT_CLASS("_TtC8TALogger12NFXHTTPModel")
...
SWIFT_CLASS("_TtC8TALogger11NFXProtocol")
...
@interface NFXProtocol (SWIFT_EXTENSION(TALogger)) <NSURLSessionDataDelegate>
...
SWIFT_CLASS("_TtC8TALogger8TALogger")
...
@interface UIBarButtonItem (SWIFT_EXTENSION(TALogger)) <AnchorView>
@property (nonatomic, readonly, strong) UIView * _Nonnull plainView;
@end
...
@interface UIView (SWIFT_EXTENSION(TALogger)) <AnchorView>
@property (nonatomic, readonly, strong) UIView * _Nonnull plainView;
@end



@interface UIWindow (SWIFT_EXTENSION(TALogger))
